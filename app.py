...
@app.route('/train',methods=['GET']) #this route is just present for quick testing once you make a change in your code and just run the pipeline again without running main from the terminal
def train():
